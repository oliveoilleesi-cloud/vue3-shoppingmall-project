            ...
            <div class="bg-slate-50 dark:bg-gray-700 p-6 rounded-xl">
              ...
              <div class="space-y-3">
                <label class="flex items-start gap-3 cursor-pointer">
                  ...
                  <span class="text-sm text-slate-600 dark:text-gray-400">I agree to the <a href="#"
                ...
                <label class="flex items-start gap-3 cursor-pointer">
                  <input type="checkbox" v-model="form.marketing"
                    class="w-5 h-5 mt-0.5 text-primary border-slate-300 rounded focus:ring-primary" />
                  <span class="text-sm text-slate-600 dark:text-gray-400">I agree to receive marketing
                    communications</span>
                </label>
                ...
                <label class="flex items-start gap-3 cursor-pointer">
                  <input type="checkbox" v-model="form.verified"
                    class="w-5 h-5 mt-0.5 text-primary border-slate-300 rounded focus:ring-primary" />
                  <span class="text-sm text-slate-600 dark:text-gray-400">I certify that I am authorized to represent
